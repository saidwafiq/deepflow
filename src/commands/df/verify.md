...
<!-- L0 existence predicate: shared via require('hooks/lib/artifact-predicates.js').checkBuildPasses (REQ-8, AC-9) -->
...
<!-- L1 scope-coverage predicate: shared via require('hooks/lib/artifact-predicates.js').checkScopeCoverage (REQ-8, AC-9) -->

...
- [x] **T1** [SPIKE]: Validate parallel sub-agent mini-plan generation and consolidation
  - Type: spike
...
- [x] **T2** [SPIKE]: Validate naive single-prompt approach (no fan-out, enhanced monolithic)
  - Type: spike
...
- [x] **T3** [SPIKE]: Validate sub-agent format consistency without structured output
  - Type: spike
...
- [x] **T4**: Implement fan-out orchestration in plan.md (sub-agent spawn)
  - Type: implementation
...
- [x] **T5**: Implement Opus consolidator replacing §5 reasoner
  - Type: implementation
  - Files: src/commands/df/plan.md
...
- [x] **T6**: Add graceful degradation and cap logic
  - Type: implementation
  - Files: src/commands/df/plan.md
...
- [x] **T7**: Verify tests and end-to-end format compliance
  - Type: implementation
